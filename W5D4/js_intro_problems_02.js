...
// "Roger" should be made to read "Mx. Roger Jingleheimer Schmidt". Then
// pass this new array of names to the callback, which should use Array.
// prototype.forEach to print out each titleized name.

function titleize(array, printCallBack){
  var named = array.map(el => `Mx. ${el} Jingleheimer Schmidt`);
  printCallBack(named);
};
